...
(function() {
  ...
  $(function() {
    var $canvas, $renderTemplate, $templ, Game, Infobar, Mouse, MouseInfo, SMOOTHNESS, TILES, TILESIZE, context, depthToLandType, displaygrid, getBoundary, grid, infobar, intensityToColor, killAllChildren, main, makegrid, mouse, mouseX, mouseY, normalize, render, renderGrid, renderSelection, rgb, snapToGrid, templ, terrainize, upperRangeBoundaries;
    TILESIZE = 20;
    TILES = 50;
    SMOOTHNESS = 10;
    $canvas = $("#canvas");
    ...
    Infobar = (function() {
      function Infobar(grid) {
        this.grid = grid;
        mouse.onclick((function(_this) {
          return function(mi) {
            return _this.click(mi);
          };
        })(this));
        this.data = {
    ...
    MouseInfo = (function() {
      function MouseInfo(x, y, tilex, tiley) {
        this.x = x;
        this.y = y;
        this.tilex = tilex;
        this.tiley = tiley;
    ...
    Mouse = (function() {
      ...
      Mouse.prototype.mousemove = function(e) {
        this.mouseX = e.pageX - $canvas.offset().left;
        return this.mouseY = e.pageY - $canvas.offset().top;
      };

      Mouse.prototype.snapToIndex = function(value) {
        return Math.floor(value / TILESIZE);
      };

      Mouse.prototype.mousedown = function(e) {
        var callback, mi, _i, _len, _ref, _results;
        mi = new MouseInfo(this.mouseX, this.mouseY, this.snapToIndex(this.mouseX), this.snapToIndex(this.mouseY));
        _ref = this.callbacks;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          callback = _ref[_i];
          _results.push(callback(mi));
        }
        return _results;
      };
